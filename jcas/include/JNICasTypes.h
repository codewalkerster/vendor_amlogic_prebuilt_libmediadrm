 ...
 */
typedef enum {
    /*Used for notify MediaCas Plugin raw event*/
    CAS_EVENT_TYPE_RAW = 0,
    /*Used for notify TvInputManager event*/
    CAS_EVENT_TYPE_STATUS = 1,
    /*Used for notify Cas Vendor provider event*/
    CAS_EVENT_TYPE_PROVIDER = 2,
    /*Used for notify content rating event*/
    CAS_EVENT_TYPE_CONTENT_RATING = 3,
} CasEventType;
...
typedef enum {
   ...
   PROVIDER_EVENT_TYPE_PVR_METADATA = 0x111,
} CasProviderEventType;
